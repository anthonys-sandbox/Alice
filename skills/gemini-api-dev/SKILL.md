---
name: gemini-api-dev
description: Gemini API development — models, SDKs, function calling, structured output, multimodal, and best practices
...
> **IMPORTANT:** Models like `gemini-2.5-*`, `gemini-2.0-*`, `gemini-1.5-*` are legacy and deprecated. Use the new models above.
...
**Always use the latest REST API discovery spec for API definitions** (request/response schemas, parameters, methods):

- **v1beta** (default): `https://generativelanguage.googleapis.com/$discovery/rest?version=v1beta`
  Use this unless explicitly pinned to v1. Official SDKs target v1beta.
- **v1**: `https://generativelanguage.googleapis.com/$discovery/rest?version=v1`
  Use only when specifically set to v1.
...
2. Fetch specific pages as needed
...
> **NOTE:** These are not all the documentation pages. Use the `llms.txt` index to discover the full set.
